 ...
 */
public interface LogRecordHandler extends Serializable {

    /**
     * 记录数据
     *
     * @param log {@link LogModel} 日志数据
     */
    void recording(LogModel log);
     ...
     */
    void recording(LogModel log, JoinPoint joinPoint);
}
