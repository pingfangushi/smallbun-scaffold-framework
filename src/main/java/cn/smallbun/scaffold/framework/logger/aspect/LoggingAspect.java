...
public class LoggingAspect {
	...
	public void logDeBefore(JoinPoint joinPoint, cn.smallbun.scaffold.framework.logger.annotation.Logger logging) {
	...
	public void doAfter(JoinPoint joinPoint, cn.smallbun.scaffold.framework.logger.annotation.Logger annotation,
			Object result) {
	 ...
	 * @return {@link Logger}
	 */
	private Logger getLog(JoinPoint joinPoint, cn.smallbun.scaffold.framework.logger.annotation.Logger annotation,
			Object result) {
		//获取请求类型
		...
		//方法名称
		logging.setMethod(joinPoint.getTarget().getClass().getName() + "." + joinPoint.getSignature().getName() + "()");
		//操作用户
